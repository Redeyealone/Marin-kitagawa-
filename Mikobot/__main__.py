...
async def gitsource_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "git_source":
        source_link = "https://github.com/dilshadhasnain07/YaeMiko"
        message_text = (
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=" BACK ", callback_data="Music_"),InlineKeyboardButton(text="SUPPORT", callback_data="Miko_support")
                    ]
                ]
            ),
        )
